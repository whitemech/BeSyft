...
if __name__ == "__main__":
    ...
    # print("Finding invariants...", end="")
    # print("NOTE: not passing in reachable_action_params.")
    # print("This means fewer invariants might be found.")
    task.INVARIANT_TIME_LIMIT = 10 # Gianmarco. TODO make it configurable param by user
    # for invariant in find_invariants(task, None):
    #     print(invariant)
    # print("Finding fact groups...")
    groups = get_groups(task)
    # Gianmarco. We print predicates, objects and invariants 
    # in separate files. We later process them to get
    # grounded invariants
