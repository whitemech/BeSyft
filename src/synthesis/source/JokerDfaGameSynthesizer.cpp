/*
*
* This file implements the JokerDfaGameSynthesizer type
...
namespace Syft {
    ...
    JokerDfaGameSynthesizer::JokerDfaGameSynthesizer(SymbolicStateDfa spec,
    ...
    CUDD::BDD JokerDfaGameSynthesizer::preimage(
    ...
    CUDD::BDD JokerDfaGameSynthesizer::preimage_star(
        const CUDD::BDD &winning_states) const {
            CUDD::BDD winning_transitions =
                winning_states.VectorCompose(transition_vector_);
            return quantify_independent_variables_star_ -> apply(winning_transitions);
    }

    CUDD::BDD JokerDfaGameSynthesizer::project_into_states(
        const CUDD::BDD& winning_moves) const {
            return quantify_non_state_variables_->apply(winning_moves);
        }
    
    bool JokerDfaGameSynthesizer::includes_initial_state(const CUDD::BDD &winning_states) const {
        std::vector<int> copy(initial_vector_);
        return winning_states.Eval(copy.data()).IsOne();
    }

    std::unordered_map<int, CUDD::BDD> JokerDfaGameSynthesizer::synthesize_strategy(
        const CUDD::BDD &winning_moves) const {
