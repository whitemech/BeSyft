/*
* This file defines the class ProvaJokerSynthesizer
...
namespace Syft
{
    ...
    ProvaJokerSynthesizer::ProvaJokerSynthesizer(std::shared_ptr<VarMgr> var_mgr,
    ...
    SynthesisResult ProvaJokerSynthesizer::run() { //ELISA CHANGED
    ...
    // void ProvaJokerSynthesizer::merge_and_dump_dot(const SynthesisResult& adversarial_result, const SynthesisResult& joker_result, const string& filename) const {
    ...
    std::vector<double> ProvaJokerSynthesizer::get_running_times() const {
        return running_times_;
   }

   void ProvaJokerSynthesizer::interactive() const {
