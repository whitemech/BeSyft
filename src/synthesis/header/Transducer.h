...
class Transducer {
  ...
  friend class SymbolicCompositionalBestEffortSynthesizer;
  friend class MonolithicBestEffortSynthesizer;
  friend class ExplicitCompositionalBestEffortSynthesizer;
