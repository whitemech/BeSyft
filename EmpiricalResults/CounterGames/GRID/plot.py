...
joker_df = pd.read_csv('joker_running_times_grid_new.csv', skiprows=1, header=None)
best_df = pd.read_csv('best_effort_running_times_grid_new.csv', skiprows=1, header=None)
...
for i in range(40):
    if i == 0:
        ...
        ax.set_title('Comparison of runtimes: GRID-1')
        ax.set_xticks(x)
        ...
        ax.set_xlabel('Instances')
        ax.set_ylabel('Runtime (s)')
        ax.set_title('Comparison of runtimes: GRID-2')
        ax.set_xticks(x)
        ax.set_xticklabels(samples, rotation=90)
        ax.set_yscale('log')
        ax.legend()
        ...
        ax.set_xlabel('Instances')
        ax.set_ylabel('Runtime (s)')
        ax.set_title('Comparison of runtimes: GRID-3')
        ax.set_xticks(x)
        ax.set_xticklabels(samples, rotation=90)
        ax.set_yscale('log')
        ax.legend()
        ...
        ax.set_xlabel('Instances')
        ax.set_ylabel('Runtime (s)')
        ax.set_title('Comparison of runtimes: GRID-4')
        ax.set_xticks(x)
        ax.set_yscale('log')
        ax.set_xticklabels(samples, rotation=90)
        ax.legend()
